# Development Pipeline — gke-cr-ebc
...
flowchart TD
    ...
    PM["PM"]
    TPM["TPM"]
    SWE1["SWE-1: Full Stack Engineer"]
    SWETEST["SWE-Test"]
    ...
    %% ── Link colors ──
    linkStyle 0,1,2,3 stroke:#2ea043,stroke-width:2px
    linkStyle 4,5,6,7 stroke:#58a6ff,stroke-width:2px
```
